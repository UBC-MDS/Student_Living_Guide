...
This app consists of a basic filter that filters the entire dashboard for specific countries or continents. But the highlight of this dashboard would be it's ability to compare the different indexes accross multiple countries and continents.
